...
<%
	dim fyft, fyst, syft, syst, tyft, tyst
	fyft = "0"
	fyst = "0"
	syft = "0"
	syst = "0"
	...
	sql_rsSheetFirstCom = "select sheet.course, sheet.score, subject.tutor, subject.credit, subject.term, subject.teachway from sheet inner join subject on sheet.course_ID = subject.course_ID where property = '必修课' and year = '第一学年' and user_ID = "&rsUser("user_ID")&" order by subject.term"
	rsSheetFirstCom.Open sql_rsSheetFirstCom,conn,1,1
	
	set rsSheetSecondCom = Server.CreateObject("Adodb.Recordset")
	sql_rsSheetSecondCom = "select sheet.course, sheet.score, subject.tutor, subject.credit, subject.term, subject.teachway from sheet inner join subject on sheet.course_ID = subject.course_ID where property = '必修课' and year = '第二学年' and user_ID = "&rsUser("user_ID")&" order by subject.term"
	rsSheetSecondCom.Open sql_rsSheetSecondCom,conn,1,1
	
	set rsSheetThirdCom = Server.CreateObject("Adodb.Recordset")
	sql_rsSheetThirdCom = "select sheet.course, sheet.score, subject.tutor, subject.credit, subject.term, subject.teachway from sheet inner join subject on sheet.course_ID = subject.course_ID where property = '必修课' and year = '第三学年' and user_ID = "&rsUser("user_ID")&" order by subject.term"
	rsSheetThirdCom.Open sql_rsSheetThirdCom,conn,1,1
	
	set rsSheetFirstOpt = Server.CreateObject("Adodb.Recordset")
	sql_rsSheetFirstOpt = "select sheet.course, sheet.score, subject.tutor, subject.credit, subject.term, subject.teachway from sheet inner join subject on sheet.course_ID = subject.course_ID where property = '选修课' and year = '第一学年' and user_ID = "&rsUser("user_ID")&" order by subject.term"
	rsSheetFirstOpt.Open sql_rsSheetFirstOpt,conn,1,1
	
	set rsSheetSecondOpt = Server.CreateObject("Adodb.Recordset")
	sql_rsSheetSecondOpt = "select sheet.course, sheet.score, subject.tutor, subject.credit, subject.term, subject.teachway from sheet inner join subject on sheet.course_ID = subject.course_ID where property = '选修课' and year = '第二学年' and user_ID = "&rsUser("user_ID")&" order by subject.term"
	rsSheetSecondOpt.Open sql_rsSheetSecondOpt,conn,1,1
	
	set rsSheetThirdOpt = Server.CreateObject("Adodb.Recordset")
	sql_rsSheetThirdOpt = "select sheet.course, sheet.score, subject.tutor, subject.credit, subject.term, subject.teachway from sheet inner join subject on sheet.course_ID = subject.course_ID where property = '选修课' and year = '第三学年' and user_ID = "&rsUser("user_ID")&" order by subject.term"
...
<table width = "1560" border = "0" cellpadding = "0" cellspacing = "0">
 <tr>
   <td height="20">&nbsp;&nbsp;&nbsp; <a href="user/user_index.asp">返 回</a></td>
 </tr>
</table>
<table width="1560" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
  ...
  <tr>
    <td width="80" rowspan="3" background="user/userimages/xncjlb.jpg">&nbsp;</td>
    <td height="40" colspan="8"><div align="center">第  一  学  年<br />                                 
    （自2005年9月至2006年6月）</div></td>
    <td width="80" rowspan="3" background="user/userimages/xncjlb.jpg">&nbsp;</td>
    <td colspan="8"><div align="center">第  二  学  年<br />                                 
    （自2006年9月至2007年6月）</div></td>
    <td width="80" rowspan="3" background="user/userimages/xncjlb.jpg">&nbsp;</td>
    <td colspan="8"><div align="center">第  三  学  年<br />                                 
    （自2007年9月至2008年6月）</div></td>
  </tr>
  ...
  <tr>
    ...
    <td height="20"><div align="left"><%=rsSheetFirstCom("course")%></div></td>	<%
		...
		fyft = CInt(fyft)+CInt(rsSheetFirstCom("credit"))
	%>
    <td><div align="center"><%=rsSheetFirstCom("credit")%></div></td>
	...
	<%
		...
		fyst = CInt(fyst)+CInt(rsSheetFirstCom("credit"))
	%>
<td><div align="center">&nbsp;</div></td>
    <td><div align="center">&nbsp;</div></td>
    <td><div align="center">&nbsp;</div></td>
    ...
    <td height="20"><div align="left"><%=rsSheetSecondCom("course")%></div></td>	<%
		...
		syft = CInt(syft)+CInt(rsSheetSecondCom("credit"))
	%>
    <td><div align="center"><%=rsSheetSecondCom("credit")%></div></td>
	...
	<%
		...
		syst = CInt(syst)+CInt(rsSheetSecondCom("credit"))
	%>
<td><div align="center">&nbsp;</div></td>
    <td><div align="center">&nbsp;</div></td>
    <td><div align="center">&nbsp;</div></td>
...
<td rowspan="10"><div align="center">
    ...
    <td height="20"><div align="left"><%=rsSheetThirdCom("course")%></div></td>	<%
		...
		tyft = CInt(tyft)+CInt(rsSheetThirdCom("credit"))
	%>
    <td><div align="center"><%=rsSheetThirdCom("credit")%></div></td>
	...
	<%
		...
		tyst = CInt(tyst)+CInt(rsSheetThirdCom("credit"))
	%>
<td><div align="center">&nbsp;</div></td>
    <td><div align="center">&nbsp;</div></td>
    <td><div align="center">&nbsp;</div></td>
...
<td><div align="center">&nbsp;<%=rsSheetThirdCom("tutor")%></div></td>	<%
  ...
  <tr>
    ...
    <td height="20"><div align="left"><%=rsSheetFirstOpt("course")%></div></td>	<%
		...
		fyft = CInt(fyft)+CInt(rsSheetFirstOpt("credit"))
	%>
    <td><div align="center"><%=rsSheetFirstOpt("credit")%></div></td>
	...
	<%
		...
		fyst = CInt(fyst)+CInt(rsSheetFirstOpt("credit"))
	%>
<td><div align="center">&nbsp;</div></td>
    <td><div align="center">&nbsp;</div></td>
    <td><div align="center">&nbsp;</div></td>
...
<td rowspan="6"><div align="center">
    ...
    <td height="20"><div align="left"><%=rsSheetSecondOpt("course")%></div></td>	<%
		...
		syft = CInt(syft)+CInt(rsSheetSecondOpt("credit"))
	%>
    <td><div align="center"><%=rsSheetSecondOpt("credit")%></div></td>
	...
	<%
		...
		syst = CInt(syst)+CInt(rsSheetSecondOpt("credit"))
	%>
<td><div align="center">&nbsp;</div></td>
    <td><div align="center">&nbsp;</div></td>
    <td><div align="center">&nbsp;</div></td>
...
<td rowspan="6"><div align="center">
    ...
    <td height="20"><div align="left"><%=rsSheetThirdOpt("course")%></div></td>	<%
		...
		tyft = CInt(tyft)+CInt(rsSheetThirdOpt("credit"))
	%>
    <td><div align="center"><%=rsSheetThirdOpt("credit")%></div></td>
	...
	<%
		...
		tyst = CInt(tyst)+CInt(rsSheetThirdOpt("credit"))
	%>
<td><div align="center">&nbsp;</div></td>
    <td><div align="center">&nbsp;</div></td>
    <td><div align="center">&nbsp;</div></td>
