...
%>
                          ...
                          女 <span class="style13">*</span> </td>
							  ...
							  %>
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <input name="user_sex" type="radio" class="style3" value="男">
                          男
                          <input name="user_sex" type="radio" class="style3" value="女" checked>
                          女 <span class="style13">*</span> </td>
                                    <%
							 end if
							 %>
...
&nbsp;&nbsp;（形式：1982-08-09） </td>
                                  ...
                                  <tr>
                                    ...
                                    <td class="style10">&nbsp;&nbsp;&nbsp;
                                        <textarea name="user_info" cols="45" rows="10"><%=HTMLEncode(rs("user_info"))%></textarea>
                                    </td>
                                  </tr>
                                  <tr>
