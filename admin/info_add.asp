                                    ...
                                    <form name="form1" method="post" action="info_add1.asp" onSubmit="return checkuser1()">
                                      <div align="center">
                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                          ...
                                          <tr>
                                            <td width="120" height="24"><div align="right" class="style10">宿舍电话：&nbsp;&nbsp;</div></td>
                                            <td colspan="2" class="style10">&nbsp;&nbsp;&nbsp;
                                          ...
                                          <tr>
                                            ...
                                            <td colspan="2" class="style10">&nbsp;&nbsp;&nbsp;
                                                <input type="text" name="user_mobile"class="style3" size="24">
                                            </td>
                                          </tr>
                                          <tr>
                                            <td width="120" height="24"><div align="right" class="style10">实验室电话：&nbsp;&nbsp;</div></td>
                                            <td colspan="2" class="style10">&nbsp;&nbsp;&nbsp;
                                                <input type="text" name="user_labphone" class="style3" size="24">
&nbsp;&nbsp;（形式：025-83594521） </td>
                                          </tr>
                                          <tr>
...
&nbsp;&nbsp;（形式：025-83594521） </td>
                                          ...
                                          <tr>
                                            ...
                                            <td colspan="2" class="style10">&nbsp;&nbsp;&nbsp;
                                                <input type="text" name="user_address"class="style3" size="24">
                                            </td>
                                          </tr>
                                          <tr>
                                            <td width="120" height="24"><div align="right" class="style10">邮编：&nbsp;&nbsp;</div></td>
                                            <td colspan="2" class="style10">&nbsp;&nbsp;&nbsp;
                                                <input type="text" name="user_code"class="style3" size="24">
                                            </td>
                                          </tr>
                                          <tr>
                                  ...
                                  女 <span class="style13">*</span> </td>
                                          ...
                                          <tr>
                                            ...
                                            <td colspan="2" class="style10">&nbsp;&nbsp;&nbsp;
                                                <input type="text" name="user_birth"class="style3" size="24">
&nbsp;&nbsp;（形式：1982-08-09）</td>
                                          </tr>
                                          <tr>
                                            <td width="120" height="24"><div align="right" class="style10">备注：&nbsp;&nbsp;</div></td>
                                            <td colspan="2" class="style10">&nbsp;&nbsp;&nbsp;
                                                <textarea name="user_info" cols="50" rows="10"></textarea>
                                            </td>
                                          </tr>
                                          <tr>
